    ...
    <html lang="en">
      <body className={font.className}>
        ...
        <AnimatedCursor innerSize={0}
          ...
          }} trailingSpeed={2} clickables={['a', 'input[type="text"]', 'input[type="email"]', 'input[type="number"]', 'input[type="submit"]', 'input[type="image"]', 'label[for]', 'select', 'textarea', 'button', '.link']} />
      </body>
    </html>
  )
}