        ...
        <div ref={bannerRef} className={bannerInView ? 'contact__banner white active' : 'contact__banner white'} {...props}>
            ...
            <div className="contact__banner-content">
                ...
                <div className="contact__banner-buttons">
                    <Button onClick={() => router.push('/contact')} className={'contact__banner-button'} type="secondary">{language.app.buttons.leaveRequest}<Icons.arrow /></Button>
                </div>
            </div>
            <div className="contact__banner-visual">
                <Image alt="contact-banner" width={1} height={1} unoptimized={true} src={'/images/banner-three.png'} />
            </div>
        </div>
    )
}